...
export const poderesDruida: Poder[] = [
  ...
  {
    nome: "Forma selvagem",
    descricao: "Você pode se transformar em animais (veja a seguir).",
    tipo: TipoPoder.classe,
    requisitos: [],
    requisitos_descricao: [],
  },
  ...
  habilidades: [
    {
      nome: "Devoto Fiel.",
      descricao:
        "Você se torna devoto de um deus disponível para druidas (Allihanna, Megalokk ou Oceano). Veja as regras de devotos na página 96. Ao contrário de devotos normais, você recebe dois poderes concedidos por se tornar devoto, em vez de apenas um.",
    },
    {
