...
export const poderesInventor: Poder[] = [
  {
    ...
    requisitos_descricao: ["Ofício (alquimista)"],
  },
  {
    nome: "Ajuste de Mira",
    descricao:
    ...
    requisitos_descricao: ["Balística"],
  },
  {
    ...
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.poder],
    requisitos_descricao: ["Alquimista Iniciado"],
  },
  {
    nome: "Alquimista Iniciado",
    descricao:
      "Você recebe um livro de fórmulas e pode fabricar poções com fórmulas que conheça de 1o e 2o círculos. Veja as páginas 333 e 341 para as regras de poções.",
    tipo: TipoPoder.classe,
  ...
  },
  {
    nome: "Armeiro",
    descricao:
      "Quando usa uma arma corpo a corpo feita por você mesmo, pode usar sua Inteligência em vez de Força nos testes de ataque e rolagens de dano.",
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.pericia, RequisitoPoder.pericia],
    requisitos_descricao: ["Luta", "Ofício (armeiro)"],
  },
  {
  ...
  },
  {
    ...
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.poder],
    requisitos_descricao: ["Engenhoqueiro"],
  },
  {
  ...
  },
  {
    ...
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.pericia, RequisitoPoder.pericia],
    requisitos_descricao: ["Ofício (armeiro)", "Pontaria"],
  },
  {
    nome: "Cano Raiado",
    descricao:
    ...
    requisitos_descricao: ["Balística", "Nível 5"],
  },
  {
  ...
  },
  {
    nome: "Couraceiro",
    descricao:
      "Você recebe proficiência com armaduras pesadas e escudos. Quando usa armadura, pode usar sua Inteligência em vez de Destreza na Defesa (mas continua não podendo somar um atributo na Defesa quando usa armadura pesada).",
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.pericia],
    requisitos_descricao: ["Ofício (armeiro)"],
  },
  {
    nome: "Engenhoqueiro",
    descricao:
    ...
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.atributo, RequisitoPoder.pericia],
    requisitos_descricao: ["Inteligência 3", "Ofício (engenhoqueiro)"],
  },
  {
    nome: "Farmacêutico",
    descricao:
    ...
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.atributo, RequisitoPoder.pericia],
    requisitos_descricao: ["Sabedoria 1", "Ofício (alquimista)"],
  },
  {
    nome: "Ferreiro",
    descricao:
    ...
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.poder, RequisitoPoder.nivel],
    requisitos_descricao: ["Armeiro", "Nível 5"],
  },
  {
    nome: "Granadeiro",
    descricao:
    ...
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.poder],
    requisitos_descricao: ["Alquimista de Batalha"],
  },
  {
    nome: "Homúnculo",
    descricao:
  ...
  },
  {
    ...
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.poder, RequisitoPoder.nivel],
    requisitos_descricao: ["Engenhoqueiro", "Nível 5"],
  },
  {
    nome: "Mestre Cuca",
    descricao:
    ...
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.pericia],
    requisitos_descricao: ["Ofício (cozinheiro)"],
  },
  {
    ...
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.poder, RequisitoPoder.nivel],
    requisitos_descricao: ["Alquimista Iniciado", "Nível 5"],
  },
  {
    nome: "Oficina de Campo",
    descricao:
      "Você pode gastar uma hora e 2 PM para fazer a manutenção do equipamento de seu grupo. Cada membro do grupo escolhe uma arma, armadura ou escudo para manutenção. Armas recebem +1 em testes de ataque, armaduras e escudos aumentam seu bônus na Defesa em +1. Os benefícios duram um dia.",
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.pericia],
    requisitos_descricao: ["Ofício (armeiro)"],
  },
  {
    ...
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.poder],
    requisitos_descricao: ["Armeiro"],
  },
  {
    nome: "Síntese Rápida",
    descricao:
      "Quando fabrica um item alquímico ou poção, você pode fabricar o dobro de doses no mesmo tempo (pagando o custo de matéria-prima de cada uma).",
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.poder],
    requisitos_descricao: ["Alquimista Iniciado"],
  },
