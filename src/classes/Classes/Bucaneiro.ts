...
export const poderesBucaneiro: Poder[] = [
  {
    ...
    requisitos_descricao: ["Flagelo dos Mares"],
  },
  {
    nome: "Aparar",
    descricao:
    ...
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.poder],
    requisitos_descricao: ["Esgrimista"],
  },
  {
    nome: "Apostador",
    descricao:
    ...
    requisitos_descricao: ["Treinado em Jogatina"],
  },
  ...
  },
  {
    nome: "Folião",
    descricao:
      "Você sabe fazer amizades durante festas, de noitadas em tavernas a bailes na corte. Nesses locais, você recebe +2 em testes de perícias de Carisma e a atitude de todas as pessoas em relação a você melhora em uma categoria.",
    tipo: TipoPoder.classe,
    requisitos: [RequisitoPoder.atributo],
  ...
  },
  {
    ...
    requisitos_descricao: ["Treinado em Luta", "Pistoleiro"],
  },
  {
    nome: "Pernas do Mar",
    descricao:
      "Você recebe +2 em Acrobacia e Atletismo. Além disso, quando está se equilibrando ou escalando, você não fica desprevenido e seu deslocamento não é reduzido à metade.",
    tipo: TipoPoder.classe,
    requisitos: [],
    requisitos_descricao: [],
  },
  ...
  },
  {
    ...
    requisitos_descricao: ["Carisma 1", "Nível 4"],
  },
];
