...
// Armas Exóticas
    ...
    // Corpo a Corpo — Duas Mãos
    {
        ...
        descricao: 'Esta arma pode ser usada para atacar inimigos a até 4,5m e pode se enroscar nas mãos, pernas ou armas de seus adversários. A corrente de espinhos é uma arma ágil, dupla e versátil, fornecendo +2 em testes para derrubar ou desarmar.',
    },
    {
        ...
        espacos: 2,
        proficiencia: 'Exótica-Duas Mãos',
        descricao: 'Uma haste comprida com uma lâmina extremamente grossa na ponta, esta é a arma favorita dos minotauros. O machado táurico é uma arma poderosa.',
    },
    // Ataque à Distância — Uma Mão
    {
        nome: 'Rede',
        ...
        espacos: 1,
        proficiencia: 'Exótica-Uma Mão',
        descricao: 'Esta arma pode ser usada para atacar inimigos a até 4,5m e pode se enroscar nas mãos, pernas ou armas de seus adversários. A rede é uma arma ágil, dupla e versátil, fornecendo +2 em testes para derrubar ou desarmar.',
    },
// Armas de Fogo
    {
        nome: 'Pistola',
...
export const tabelaItens: Item[] = [
    ...
    },
    {
        ...
        espacos: 1,
        categoria: 'Ferramentas',
        descricao: 'Uma peça de couro e pelego colocada sobre o lombo da montaria, sobre a qual o cavaleiro se senta. Inclui arreios para conduzir o animal. Um ersonagem montado em uma montaria  sem sela sofre –5 em testes de Cavalgar. Usada no animal, a sela não ocupa espaço de carga do personagem.'
    },
    {
        ...
        espacos: 1,
        categoria: 'Ferramentas',
        descricao: 'Um tambor de madeira com pele de animal esticada. Um bardo que empunhe este item aumenta a CD para resistir às magias lançadas por ele em +1. Conta como um instrumento musical.'
    },
    //Vestuario
    {
...
feito para um tipo de terreno específico (veja a habi-
lidade Explorador, na página 51). Por exemplo, um

manto camuflado para floresta pode ser verde e mar-
rom e coberto de folhas, enquanto um manto urbano
...
aprimoram o equilíbrio e a firmeza dos pés, forne-
cendo +1 em Acrobacia.
...
medida e adequadas à nobreza e realeza. Inclui algu-
mas joias, como aneis e colares. Em certos ambientes
