...
import { Magia, enumTipo } from "../../classes/Construtores/Magia";
  ...
  return (
    <>
      <section className="border border-black rounded-lg shadow-[5px_5px_0px_0px_rgba(155,0,0)] p-4 bg-opacity-80 text-center bg-white">
        ...
        {magias.length !== 0 && <MagiasCards magias={magias} tipo="ficha" />}
      </section>
      <Modal isOpen={isOpen} onClose={() => setIsOpen(false)}>
        <ModalOverlay backdropFilter="blur(5px)" />
        <ModalContent>
          <ModalHeader>Escolha uma magia para adicionar a ficha</ModalHeader>
          <ModalBody>
            <Select
            ...
            {magiaSelecionada && (
              <div className="bg-bgT20 pb-2 px-2 rounded-xl font-tormenta">
                <div className="flex justify-between w-full text-white">
                  <p className="text-left my-auto">{magiaSelecionada.nome}</p>
                  <div
                  ...
                  >
                    <img
                      ...
                      className="w-6 h-6"
                    />
                    <p className="text-center">{magiaSelecionada.circulo}</p>
                  </div>
                </div>
                <p className="flex justify-evenly flex-wrap w-full text-white">
                  ...
                  <p className="flex text-base">
                    <img src="./img/magias/dados/alcance.svg" className="w-6" />
                    <p className="my-auto">{magiaSelecionada.alcance}</p>
                  </p>
                  <p className="flex text-base">
                    <img src="./img/magias/dados/duracao.svg" className="w-6" />
                    <p className="my-auto">{magiaSelecionada.duracao}</p>
                  </p>
                  <p className="flex text-base">
                    <img src="./img/magias/dados/alvo.svg" className="w-6" />
                  ...
                  {magiaSelecionada.resistencia === "" ? null : (
                    <p className="flex text-base">
                      <img
                        ...
                        className="w-6"
                      />
                      <p className="my-auto">{magiaSelecionada.resistencia}</p>
                    </p>
                  )}
                </p>
